...
class StatusFilter(django_filters.FilterSet):
    ...
    class Meta:
        model = Status
        fields = ['numero_de_trabajador','empresa','nombres_apellidos','profesion','tipo_de_contrato','distrito']
...
class BancariosFilter(django_filters.FilterSet):
    ...
    class Meta:
        ...
        fields = ['nombres_apellidos','no_de_cuenta','banco','distrito',]
...
class CostoFilter(django_filters.FilterSet):
    ...
    class Meta:
        model = Costo
        fields = ['numero_de_trabajador','nombres_apellidos','empresa','distrito']
...
class BonosFilter(django_filters.FilterSet):
    ...
    class Meta:
        model = Bonos
        fields = ['start_date','end_date','nombres_apellidos','distrito',]
